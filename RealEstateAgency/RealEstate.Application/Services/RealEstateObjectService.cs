...
public class RealEstateObjectService(IRepository<RealEstateObject, int> repo, IMapper mapper)
    : IApplicationService<RealEstateObjectDto, RealEstateObjectCreateUpdateDto, int>
{
    /// <summary>
